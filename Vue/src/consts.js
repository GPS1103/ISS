export const SETTINGS_FIELDS = { 
  WaterContainer1: [
    { name: 'Pow. przekroju poprz. zbiornika', initialValue: 1, units: 'm2', min: 0.5, max: 25, interval: 0.1 },           //A - powierzchnia zbiornika
    { name: 'Współczynnik wypływu', initialValue: 0.01, units: 'none', min: 0.01, max: 5, interval: 0.001 },         //Beta - współczynnik wypływu?
    { name: 'Natężenie dopływu', initialValue: 0.01, units: 'm^3/s', min: 0.1, max: 5, interval: 0.01 },                  //Qd 
   // { name: 'Ciśnienie wypływu', initialValue: 0, units: 'm3' },               //Q0 - nieużywane 
    ...
    { name: 'Częstotliwość próbkowania', initialValue: 1, units: 'none', min: 0.1, max: 10, data: [0.01, 0.1, 1] },                  //Tp - próbkowanie
  ...
  WaterContainer2: [
    ...
    { name: 'Natężenie dopływu składnika 1', initialValue: 0.01, units: 'm^3/s', min: 0.01, max: 10, interval: 0.1 },                  //Q1 
    { name: 'Natężenie dopływu składnika 2', initialValue: 0.01, units: 'm^3/s', min: 0.01, max: 10, interval: 0.1},        //Qd2
    { name: 'Natężenie wypływu', initialValue: 0.01, units: 'm^3/s', min: 0.1, max: 20, interval: 0.1 },        //Qo
  ...
  WaterContainer3: [
    { name: 'Powierzchnia przekroju poprzecznego zbiornika', initialValue: 1, units: 'm2', min: 0.5, max: 25, interval: 0.1 },           //A - powierzchnia zbiornika
    { name: 'Współczynnik wypływu', initialValue: 0.01, units: 'none', min: 0.01, max: 5, interval: 0.001 },         //Beta - współczynnik wypływu?
    { name: 'Natężenie dopływu', initialValue: 0.01, units: 'm^3/s', min: 0, max: 5, interval: 0.01 },                  //Qd 
    ...
    { name: 'Maksymalne natężenie dopływu', initialValue: 0.1, units: 'none', min: 0.1, max: 5, interval: 0.1 },         //max
  ...
  WaterContainer3_1: [
    ...
    // for recheck
    { name: 'Zadany poziom cieczy', initialValue: 5, units: 'm', min: 0.1, max: 20, interval: 0.1 },        //target_level
    { name: 'Maksymalne natężenie dopływu', initialValue: 0.1, units: 'none', min: 0.1, max: 5, interval: 0.1 },         //max         //max
    { name: 'Wersja AI', units: 'none', initialValue: 0, data: {0:'Regresja', 1:'Genetyczna'} },                  //version
    //
    { name: 'Częstotliwość próbkowania', initialValue: 1, units: 'none', min: 0.1, max: 10, data: [0.01, 0.1, 1] },                  //Tp - próbkowanie
    { name: 'Czas symulacji', initialValue: 1, units: 'h', min: 0.25, max: 24, interval: 0.5 },                 //SimulationLength - czas symulacji w godzinach
  ],
  WaterContainer4: [
    { name: 'Powierzchnia przekroju poprzecznego zbiornika', initialValue: 1, units: 'm2', min: 0.5, max: 10, interval: 0.1 },           //A - powierzchnia zbiornika
    { name: 'Stężenie substancji', initialValue: 0.1, units: '%', min: 0.1, max: 1, interval: 0.01 },         //c
    { name: 'Natężenie dopływu składnika 1', initialValue: 0.01, units: 'm^3/s', min: 0.01, max: 10, interval: 0.1 },                  //Q1 
    { name: 'Natężenie wpływu składnika 2', initialValue: 0.01, units: 'm^3/s', min: 0.01, max: 10, interval: 0.1},        //Qd2
    { name: 'Natężenie wypływu', initialValue: 0.01, units: 'm^3/s', min: 0.1, max: 20, interval: 0.1 },        //Qo
    { name: 'Stężenie składnika 1', initialValue: 0.1, units: '%', min: 0.1, max: 1, interval: 0.01 },        //c1
    { name: 'Stężenie składnika 2', initialValue: 0.1, units: '%', min: 0.1, max: 1, interval: 0.01 },    //c2
    ...
    { name: 'Maksymalne natężenie dopływu', initialValue: 0.1, units: 'none', min: 0.1, max: 5, interval: 0.1 },    //maxinput
    { name: 'Wysokość maksymalna cieczy', initialValue: 0.1, units: 'none', min: 0.1, max: 20, interval: 0.1 },    //vMax
  ...
  WaterContainer5: [
    { name: 'Powierzchnia przekroju poprzecznego zbiornika', initialValue: 1, units: 'm2', min: 0.5, max: 10, interval: 0.1 },           //A - powierzchnia zbiornika
    { name: 'Współczynnik wypływu', initialValue: 0.01, units: 'none', min: 0.001, max: 0.5, interval: 0.001 },         //Beta - współczynnik wypływu?
    { name: 'Maksymalne natężenie dopływu', initialValue: 0.01, units: 'm^3/s', min: 0.1, max: 5, interval: 0.1 },                  //Qd 
    { name: 'Aktualny poziom cieczy', initialValue: 1, units: 'm', min: 0.1, max: 20, interval: 0.1 },        //h
    ...
    { name: 'Częstotliwość próbkowania', initialValue: 1, units: 'none', data: [0.01, 0.1, 1] },                  //Tp - próbkowanie
    { name: 'Czas symulacji', initialValue: 1, units: 'h', min: 0.25, max: 24, interval: 0.5 },                 //SimulationLength - czas symulacji w godzinach
  ]
