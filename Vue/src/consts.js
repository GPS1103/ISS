export const SETTINGS_FIELDS = { 
  WaterContainer1: [
    { name: 'Powierzchnia zbiornika', initialValue: 1, units: 'm<sup>2</sup>', min: 0.5, max: 25, interval: 0.1 },           //A - powierzchnia zbiornika
    { name: 'Współczynnik przepływu', initialValue: 0.01, units: '', min: 0.01, max: 5, interval: 0.01 },         //Beta - współczynnik wypływu?
    { name: 'Ciśnienie wpływu', initialValue: 0.1, units: 'm<sup>3</sup>/s', min: 0.1, max: 5, interval: 0.01 },                  //Qd 
  ...
  WaterContainer2: [
    ...
    { name: 'Ciśnienie wpływu składnika 1', initialValue: 0.1, units: 'm<sup>3</sup>/s', min: 0.1, max: 10, interval: 0.1 },                  //Q1 
    { name: 'Ciśnienie wpływu składnika 2', initialValue: 0.1, units: 'm<sup>3</sup>/s', min: 0.1, max: 10, interval: 0.1},        //Qd2
    { name: 'Cisnienie wypływu', initialValue: 0.1, units: 'm<sup>3</sup>/s', min: 0.1, max: 20, interval: 0.1 },        //Qo
  ...
  WaterContainer3: [
    { name: 'Powierzchnia zbiornika', initialValue: 1, units: 'm<sup>2</sup>', min: 0.5, max: 25, interval: 0.1 },           //A - powierzchnia zbiornika
    { name: 'Współczynnik przepływu', initialValue: 0.01, units: '', min: 0.01, max: 5, interval: 0.01 },         //Beta - współczynnik wypływu?
    { name: 'Ciśnienie wpływu', initialValue: 0.01, units: 'm<sup>3</sup>/s', min: 0, max: 5, interval: 0.01 },                  //Qd 
    ...
    { name: 'Maksymalne ciśnienie wpływu', initialValue: 0.1, units: '', min: 0.1, max: 5, interval: 0.1 },         //max
  ...
  WaterContainer3_1: [
    ...
    // for recheck
    { name: 'Zadany poziom cieczy', initialValue: 5, units: 'm', min: 0.1, max: 20, interval: 0.1 },        //target_level
    { name: 'Maksymalne ciśnienie wpływu', initialValue: 0.1, units: '', min: 0.1, max: 5, interval: 0.1 },         //max         //max
    { name: 'Wersja', units: '', initialValue: 0, data: {0:'Regresja', 1:'Genetyczna'} },                  //version
    //
    { name: 'Próbkowanie', initialValue: 1, units: '', min: 0.1, max: 10, data: [0.01, 0.1, 1] },                  //Tp - próbkowanie
    { name: 'Czas symulacji', initialValue: 1, units: 'h', min: 0.25, max: 24, interval: 0.25 },                 //SimulationLength - czas symulacji w godzinach
  ],
  WaterContainer4: [
    { name: 'Powierzchnia zbiornika', initialValue: 1, units: 'm<sup>2</sup>', min: 0.5, max: 10, interval: 0.1 },           //A - powierzchnia zbiornika
    { name: 'Stężenie substancji', initialValue: 0.1, units: '%', min: 0.1, max: 1, interval: 0.01 },         //c
    { name: 'Ciśnienie wpływu składnika 1', initialValue: 0.1, units: 'm<sup>3</sup>/s', min: 0.1, max: 10, interval: 0.1 },                  //Q1 
    { name: 'Ciśnienie wpływu składnika 2', initialValue: 0.1, units: 'm<sup>3</sup>/s', min: 0.1, max: 10, interval: 0.1},        //Qd2
    { name: 'Ciśnienie wypływu', initialValue: 0.1, units: 'm<sup>3</sup>/s', min: 0.1, max: 20, interval: 0.1 },        //Qo
    { name: 'Stężenie składnika 1', initialValue: 0.1, units: '%', min: 0.1, max: 1, interval: 0.01 },        //c1
    { name: 'Stężenie składnika 2', initialValue: 0.1, units: '%', min: 0.1, max: 1, interval: 0.01 },    //c2
    ...
    { name: 'Maksymalne ciśnienie wpływu', initialValue: 0.1, units: '', min: 0.1, max: 5, interval: 0.1 },    //maxinput
    { name: 'Wysokość maksymalna', initialValue: 0.1, units: '', min: 0.1, max: 20, interval: 0.1 },    //vMax
  ...
  WaterContainer5: [
    { name: 'Powierzchnia zbiornika', initialValue: 1, units: 'm<sup>2</sup>', min: 0.5, max: 10, interval: 0.1 },           //A - powierzchnia zbiornika
    { name: 'Współczynnik przepływu', initialValue: 0.01, units: '', min: 0.01, max: 0.5, interval: 0.01 },         //Beta - współczynnik wypływu?
    { name: 'Maksymalne ciśnienie wpływu', initialValue: 0.01, units: 'm<sup>3</sup>/s', min: 0.1, max: 5, interval: 0.1 },                  //Qd 
    { name: 'Aktualny poziom cieczy', initialValue: 1, units: 'm', min: 0.1, max: 20, interval: 0.1 },        //h
    { name: 'Maksymalna wysokość zbiornika', initialValue: 5, units: 'm', min: 0.1, max: 20, interval: 0.1 },        //hMax
    { name: 'Zadany poziom cieczy', initialValue: 5, units: 'm', min: 0.1, max: 20, interval: 0.1 },        //hMax
    { name: 'Próbkowanie', initialValue: 1, units: '', data: [0.01, 0.1, 1] },                  //Tp - próbkowanie
    { name: 'Czas symulacji', initialValue: 1, units: 'h', min: 0.25, max: 24, interval: 0.25 },                 //SimulationLength - czas symulacji w godzinach
  ]
